...
An OSC packet consists of its contents, a contiguous block of binary data, and
...
[            | Indicates the beginning of an array.
...
Printable ASCII characters not allowed in names of OSC Methods or OSC
Containers
